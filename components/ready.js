      ...
      <div className="row section-title justify-content-center text-center">
        ...
        >
          <div className="row justify-content-center mt-3 ready-button">
            <a href="https://www.wjx.top/vm/eu49KuE.aspx#" target="_blank">
            ...
            <div className="row guizhang-button m-2 justify-content-center align-items-center">
                <a
                  href="https://docs.qq.com/document/DWVZHVEpFRW50aFdr"
                  target="_blank"
                >
                <div>社团简介</div>
              </a>
