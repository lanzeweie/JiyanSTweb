        ...
        <div className="container mt-4">
          <div className="row mt-5 justify-content-center">
            <div className="col-md-9 col-lg-8 col-xl-7">
              <h1 className="page-title">研究部</h1>
          ...
          >
            <div>
              <div className="row mt-4 justify-content-start mr-0 ml-0">
                ...
                <div className="col-10">
                  <div className="yanjiubu-zhuye-title">{t("yanjiu1-1")}</div>
                  <div className="yanjiubu-zhuye-subtitle">
                    {t("yanjiu1-2")}
                  </div>
            ...
            <div>
              <div className="row mt-4 justify-content-start mr-0 ml-0">
                ...
                <div className="col-10">
                <div className="yanjiubu-zhuye-title">{t("yanjiu2-1")}</div>
                  <div className="yanjiubu-zhuye-subtitle">
                    {t("yanjiu2-2")}
                  </div>
                </div>
...
Support.getInitialProps = async () => ({
  namespacesRequired: ["common", "header","yanjiubu"],
});
Support.propTypes = {
  t: PropTypes.func.isRequired,
};

export default withTranslation("yanjiubu")(Support);
